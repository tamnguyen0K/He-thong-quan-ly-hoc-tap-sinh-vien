...
/**
 * Utility class để quản lý kết nối database Cung cấp method getConnection() để
 * lấy Connection đến MySQL
 */
public class DBUtil {
    ...
    private static final String DB_PASSWORD = "1111"; // Điền password MySQL của bạn vào đây
